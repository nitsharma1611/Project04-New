...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.VehicleBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Vehicle" : "Add Vehicle"%>
			</h5>
			...
			<form action="<%=ORSView.VEHICLE_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("vehicleName", request)%>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<input type="text"
						name="modelName"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getModelName())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("modelName", request)%>
					</div>
				</div>
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<input type="text"
						name="color"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getColor())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("color", request)%>
					</div>
				</div>
