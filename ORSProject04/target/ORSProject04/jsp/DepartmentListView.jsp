				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=bean.getHodName()%></td>

							<td><%=bean.getTotalFaculty()%></td>
							<td><%=bean.getLocation()%></td>

							<td><span class="badge bg-success"> <%=bean.getStatus()%>
							</span></td>

							<td><a href="DepartmentCtl?id=<%=bean.getId()%>"
