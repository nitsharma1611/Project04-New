	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-p-square-fill me-2"></i>SmartLight List
			</h5>

			<div class="d-flex gap-2">

				<a href="<%=ORSView.SMART_LIGHT_REPORT_CTL%>" target="_blank"
					class="btn btn-warning btn-sm fw-semibold"> <i
					class="bi bi-file-earmark-pdf"></i> Print PDF
				</a> <a href="<%=ORSView.SMART_LIGHT_REPORT_CTL%>?type=doc"
