...
<div class="col-6 col-md-4 col-lg-3">
			<a href="<%=ORSView.SMART_PARKING_LIST_CTL%>" class="text-decoration-none">
				<div
					class="card h-100 border-0 shadow-sm rounded-4 text-center p-3 ors-card"
					style="border-top: 4px solid #0891b2;">
					<div class="fs-1 mb-2" style="color: #0891b2;">
					...
					<p class="text-muted small mb-0">Smart Parking </p>
				</div>
			</a>
		</div>
		
		<div class="col-6 col-md-4 col-lg-3">
			<a href="<%=ORSView.DRONE_DELIVERY_LIST_CTL%>" class="text-decoration-none">
				<div
					class="card h-100 border-0 shadow-sm rounded-4 text-center p-3 ors-card"
					style="border-top: 4px solid #0891b2;">
					<div class="fs-1 mb-2" style="color: #0891b2;">
					...
					<h6 class="fw-bold mb-1">Drone Delivery</h6>
					<p class="text-muted small mb-0">Drone Delivery </p>
				</div>
			</a>
		</div>
