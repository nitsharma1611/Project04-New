...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.WaterMonitoringBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit WaterMonitoring" : "Add WaterMonitoring"%>
			</h5>
			...
			<form action="<%=ORSView.WATER_MONITORING_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("waterCode", request)%>
					</div>
				</div>
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<input type="text"
						name="waterLevel"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getWaterLevel())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("waterLevel", request)%>
					</div>
				</div>
				...
				<div class="d-flex border-top pt-3">
					...
					<a href="WaterMonitoringListCtl?id=0"
