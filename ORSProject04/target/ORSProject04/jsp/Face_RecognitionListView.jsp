...
<%@page import="com.sunilos.p4.bean.FaceRecognitionBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-bank2 me-2"></i> Face Recognition
			</h5>
			<div class="d-flex gap-2">
				...
				</a>  <a href="FaceRecognitionCtl"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-plus-circle me-1"></i> Add Face RecognitionCtl
				</a>
			</div>
		</div>

		<form action="<%=ORSView.FACE_RECOGNITION_LIST_CTL%>" method="POST">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getFaceCode()%></td>
							<td><%=bean.getUserName()%></td>
							<td><%=bean.getImagePath()%></td>
							<td><%=bean.getStatus()%></td>
						
							<td><a href="FaceRecognitionCtl?id=<%=bean.getId()%>"
