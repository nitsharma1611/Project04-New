...
<div class="container-fluid px-4 py-4" style="max-width: 1200px;">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-p-square-fill me-2"></i> Voice Command List
			</h5>
 ...
 --%>
				<a href="<%=ORSView.VOICE_COMMAND_CTL%>"
					class="btn btn-light btn-sm text-primary fw-semibold"> <i
					class="bi bi-plus-circle"></i> ADD VoiceCommand
				</a>
		...
		<form action="<%=ORSView.VOICE_COMMAND_LIST_CTL%>" method="post">
			...
			<div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2">
				...
				<input type="text" name="commandCode"
					...
					placeholder="Search commandCode"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=bean.getCommandCode()%></td>

							<td><%=bean.getUserName()%></td>

							<td><%=bean.getCommandText()%></td>
