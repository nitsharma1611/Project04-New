...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.SmartLightBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit SmartLight" : "Add SmartLight"%>
			</h5>
			...
			<form action="<%=ORSView.SMART_LIGHT_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<input type="text"
						name="lightCode"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getLightCode())%>">
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<input type="text"
						...
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getBrightnessLevel())%>">
