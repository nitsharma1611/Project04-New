				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=bean.getExamName()%></td>

							<td><%=bean.getExamDate()%></td>

							<td><%=bean.getTotalMarks()%></td>

							<td><%=bean.getPassingMarks()%>
							</td>

							<td><a href="ExamCtl?id=<%=bean.getId()%>"
