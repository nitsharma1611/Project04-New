...
<div class="container-fluid px-4 py-4" style="max-width: 1200px;">
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-p-square-fill me-2"></i>Water Monitoring List
			</h5>

			<div class="d-flex gap-2">

				 <a href="<%=ORSView.WATER_MONITORING_REPORT_CTL%>"
					target="_blank"
  			...
  			<a href="<%=ORSView.WATER_MONITORING_REPORT_CTL%>?type=doc"
					target="_blank"
	...
	<a href="<%=ORSView.WATER_MONITORING_CTL%>"
...
WaterMonitoringBean bean = it.next();
						...
						<tr>
							...
							<td><%=bean.getWaterCode()%></td>

							<td><%=bean.getLocation()%></td>

							<td><%=bean.getWaterLevel()%></td>
