...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.BookBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Book" : "Add Book"%>
			</h5>
		...
		<div class="card-body">
			...
			<form action="<%=ORSView.BOOK_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("author", request)%>
					</div>
				</div>
...
<div class="col-md-6">
					...
					<input type="text"
						...
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getPublicationYear())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("publicationYear", request)%>
					</div>
				</div>
				<!-- Status -->
