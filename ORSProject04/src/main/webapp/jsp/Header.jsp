		...
		<div class="collapse navbar-collapse" id="mainNav">
			...
			<ul class="navbar-nav me-auto gap-0">
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle px-3 py-3" href="#"
					data-bs-toggle="dropdown" aria-expanded="false"> <i
						class="bi bi-file-earmark-bar-graph me-1"></i> Daily Module
				</a>
					<ul
						class="dropdown-menu dropdown-menu-dark shadow border-0 rounded-3"
						style="min-width: 230px; background: #1a2e4a;">
						...
						<li><a class="dropdown-item"
							href="<%=ORSView.DRONE_DELIVERY_LIST_CTL%>" target="_blank">
								<i class="bi bi-file-earmark-pdf me-2 text-warning"></i> Drone
								Delivery
						</a></li>
						<li><a class="dropdown-item"
							href="<%=ORSView.SMART_PARKING_LIST_CTL%>" target="_blank"> <i
								class="bi bi-file-earmark-pdf me-2 text-warning"></i>
								Smart_Parking
						</a></li>
						<li><a class="dropdown-item"
							href="<%=ORSView.WEATHERALERT_LIST_CTL%>" target="_blank"> <i
								class="bi bi-file-earmark-pdf me-2 text-warning"></i> Weather
								Alert
						</a></li>
...
<li><a class="dropdown-item"
							href="<%=ORSView.EVENT_LIST_CTL%>" target="_blank"> <i
