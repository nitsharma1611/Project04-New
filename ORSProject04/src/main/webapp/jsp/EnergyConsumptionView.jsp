...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.EnergyConsumptionBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit EnergyConsumption" : "Add EnergyConsumption"%>
			</h5>
			...
			<form action="<%=ORSView.ENERGY_CONSUMPTION_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("energyCode", request)%>
					</div>
				</div>
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("unitsConsumed", request)%>
					</div>
				</div>
				...
				<div class="d-flex border-top pt-3">
					...
					<a href="EnergyConsumptionListCtl?id=0"
