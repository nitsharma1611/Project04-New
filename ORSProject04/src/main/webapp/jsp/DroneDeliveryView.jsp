...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.DroneDeliveryBean"
...
statusMap.put("InTransit", "InTransit");
statusMap.put("Charging", "Charging");
			...
			<input type="hidden" name="id" value="<%=bean.getId()%>">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("droneCode", request)%>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("operatorName", request)%>
					</div>
				</div>
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("deliveryZone", request)%>
					</div>
				</div>
				...
				<div class="d-flex border-top pt-3">
					...
					<a href="DroneDeliveryListCtl?id=0"
