...
<%@page import="com.sunilos.p4.bean.WeatherAlertBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-bank2 me-2"></i> Weather Alert List
			</h5>
			<div class="d-flex gap-2">
				...
				</a> <a href="<%=ORSView.WEATHERALERT_CTL%>"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-plus-circle me-1"></i> Add Weather Alert
				</a>
			</div>
		</div>

		<form action="<%=ORSView.WEATHERALERT_LIST_CTL%>" method="POST">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getAlertCode()%></td>
							<td><%=bean.getCityName()%></td>
							<td><%=bean.getTemperature()%></td>
							<td><%=bean.getStatus()%></td>

							<td><a
								href="<%=ORSView.WEATHERALERT_CTL%>?id=<%=bean.getId()%>"
