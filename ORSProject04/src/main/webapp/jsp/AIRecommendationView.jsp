...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.AIRecommendationBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit AIRecommendation" : "Add AIRecommendation"%>
			</h5>
			...
			<form action="<%=ORSView.AI_RECOMMENDATION_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<input type="text"
						...
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getRecommendationCode())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("recommendationCode", request)%>
					</div>
				</div>
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<input type="text"
						...
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getRecommendationType())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("recommendationType", request)%>
					</div>
				</div>
				...
				<div class="d-flex border-top pt-3">
					...
					<a href="AIRecommendationListCtl?id=0"
