	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-p-square-fill me-2"></i>Event List
			</h5>
			...
			<div class="d-flex gap-2">
				...
				<a href="<%=ORSView.EVENT_REPORT_CTL%>" target="_blank"
					...
					class="btn btn-info btn-sm fw-semibold"> <i
					class="bi bi-file-earmark-word"></i> Print DOC
				</a> <a href="<%=ORSView.EVENT_CTL%>"
					class="btn btn-light btn-sm text-primary fw-semibold"> <i
					class="bi bi-plus-circle"></i> Add Event
				</a>
		...
		<form action="<%=ORSView.EVENT_LIST_CTL%>" method="post">
			...
			<div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2">
				...
				<input type="text" name="venue"
					...
					value="<%=ServletUtility.getParameter("venue", request)%>">
