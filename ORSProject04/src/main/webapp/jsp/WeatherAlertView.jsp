...
statusMap.put("Hot", "Hot");
statusMap.put("Warm", "Warm");
statusMap.put("Humid", "Humid");
statusMap.put("Pleasant", "Pleasant");
statusMap.put("Cloudy", "Cloudy");
statusMap.put("Rain Alert", "Rain Alert");
statusMap.put("Extreme Heat", "Extreme Heat");
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Weather Alert" : "Add Weather Alert"%>
			</h5>
			...
			<form action="<%=ORSView.WEATHERALERT_CTL%>" method="post">
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("alertCode", request)%>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("cityName", request)%>
					</div>
				</div>
