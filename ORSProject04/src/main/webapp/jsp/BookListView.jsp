<%@page import="com.sunilos.p4.bean.BookBean"%>
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="BookCtl?id=<%=bean.getId()%>"
