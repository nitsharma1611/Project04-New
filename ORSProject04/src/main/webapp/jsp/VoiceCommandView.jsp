...
<jsp:useBean id="bean"
	class="com.sunilos.p4.bean.VoiceCommandBean"
	...
	<div class="card border-0 shadow-sm rounded-4">
		...
		<div class="card-header text-white py-3"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit VoiceCommand" : "Add VoiceCommand"%>
			</h5>
			...
			<form action="<%=ORSView.VOICE_COMMAND_CTL %>" method="post">
				...
				<div class="mb-3">
					...
					<input type="text"
						name="commandCode"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getCommandCode())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("commandCode", request)%>
					</div>
				</div>
...
<div class="row g-3 mb-3">
				<div class="col-md-6">
					...
					<input type="text"
						name="command Text"
						class="form-control"
						value="<%=DataUtility.getStringData(bean.getCommandText())%>">

					<div class="text-danger small mt-1">
						<%=ServletUtility.getErrorMessage("command Text", request)%>
					</div>
				</div>
